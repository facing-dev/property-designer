...
export class Property<Metadata extends MetadataT, Properties extends PropertyArray, Context> {
    ...
    arrayInsertItem<T extends CommonPropertyArray<Metadata>>(property: T, at: number, array: Array<any>, value: T extends { valueProperties: infer v } ? (v extends PropertyArray<Metadata> ? ValueBox<v> : never) : never) {
        if (at > array.length) {
    ...
    generateDefaultArrayItem<T extends CommonPropertyArray<Metadata>>(property: T): T extends { valueProperties: infer v } ? v extends PropertyArray<Metadata> ? ValueBox<v> : never : never {
        const v: any = {}
